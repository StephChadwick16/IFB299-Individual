...
#
# OPTIONS:
#   sourcefilename=C:\Users\Stephanie\Documents\Semester 2 2016\IFB299\Full Database Editable.accdb
#   sourceusername=
#   sourcepassword=
...
#
# Table structure for table 'Health & Safety Violations'
#

DROP TABLE IF EXISTS `Health & Safety Violations`;

CREATE TABLE `Health & Safety Violations` (
  `Number` INTEGER NOT NULL AUTO_INCREMENT, 
  `Location of issue` LONGTEXT, 
...
#
# Dumping data for table 'Health & Safety Violations'
#
...
#
# Table structure for table 'Smoking Violations'
#

DROP TABLE IF EXISTS `Smoking Violations`;
...
#
# Dumping data for table 'Smoking Violations'
#
...
CREATE TABLE `User Info` (
  ...
  `Work Phone (for Staff)` INTEGER DEFAULT 0, 
  ...
  `Visitor Full Name` VARCHAR(255), 
  `Reson for Visit` VARCHAR(255), 
  `Vehicle Type (see carpark map)` VARCHAR(255), 
  `Vehicle Registration Number` VARCHAR(255), 
...
INSERT INTO `User Info` (`Application / Permit Number`, `Staff or Student ID`, `Title`, `Full Name`, `Date of Birth`, `Work Phone (for Staff)`, `Mobile Phone`, `Email Address`, `Department/Faculty`, `Are you Applying for a visitor?`, `Visitor Full Name`, `Reson for Visit`, `Vehicle Type (see carpark map)`, `Vehicle Registration Number`, `Vehicle Make and Model`) VALUES (1, 7839281, 'Mr', 'John Smith', '1960-03-10 00:00:00', 38792019, 473829102, 'John.Smith@gmail.com', 'SEF', 0, NULL, NULL, 'Small Car', 'VHG 785', 'Toyota Yaris');
INSERT INTO `User Info` (`Application / Permit Number`, `Staff or Student ID`, `Title`, `Full Name`, `Date of Birth`, `Work Phone (for Staff)`, `Mobile Phone`, `Email Address`, `Department/Faculty`, `Are you Applying for a visitor?`, `Visitor Full Name`, `Reson for Visit`, `Vehicle Type (see carpark map)`, `Vehicle Registration Number`, `Vehicle Make and Model`) VALUES (2, 9876989, 'Ms', 'Anna Jones', '1987-08-07 00:00:00', 0, 478219989, 'Anna.Jones7@hotmail.com', 'Law', 0, NULL, NULL, 'Small Car', 'AMJ 708', 'Mazda 2');
INSERT INTO `User Info` (`Application / Permit Number`, `Staff or Student ID`, `Title`, `Full Name`, `Date of Birth`, `Work Phone (for Staff)`, `Mobile Phone`, `Email Address`, `Department/Faculty`, `Are you Applying for a visitor?`, `Visitor Full Name`, `Reson for Visit`, `Vehicle Type (see carpark map)`, `Vehicle Registration Number`, `Vehicle Make and Model`) VALUES (3, 24350, NULL, NULL, NULL, 0, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `User Info` (`Application / Permit Number`, `Staff or Student ID`, `Title`, `Full Name`, `Date of Birth`, `Work Phone (for Staff)`, `Mobile Phone`, `Email Address`, `Department/Faculty`, `Are you Applying for a visitor?`, `Visitor Full Name`, `Reson for Visit`, `Vehicle Type (see carpark map)`, `Vehicle Registration Number`, `Vehicle Make and Model`) VALUES (4, 2340, NULL, NULL, NULL, 0, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `User Info` (`Application / Permit Number`, `Staff or Student ID`, `Title`, `Full Name`, `Date of Birth`, `Work Phone (for Staff)`, `Mobile Phone`, `Email Address`, `Department/Faculty`, `Are you Applying for a visitor?`, `Visitor Full Name`, `Reson for Visit`, `Vehicle Type (see carpark map)`, `Vehicle Registration Number`, `Vehicle Make and Model`) VALUES (5, 23450, NULL, NULL, NULL, 0, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);
# 5 records
